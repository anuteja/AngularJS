...
function setupModuleLoader(window) {
  ...
  return ensure(ensure(window, 'angular', Object), 'module', function() {
     ...
     * # Module
     *
     * A module is a collocation of services.js, directives, filters.js, and configuration information. Module
     ...
     *
     * // configure existing services.js inside initialization blocks.
 ...
 *
 * @description
 * Creates an injector function that can be used for retrieving services.js as well as for
 ...
 * to determine which services.js need to be injected into the function when the function is invoked. There are three
 ...
 * services.js to be injected into the function.
 * <pre>
 *   // Given
 ...
 *   above.
 *
 * @returns {Array.<string>} The names of the services.js which the function requires.
 */
 ...
 * @description
 *
 * A short hand for configuring services.js if only `$get` method is required.
 *
 ...
 * @description
 *
 * A short hand for configuring services.js if the `$get` method is a constant.
 *
 * @param {string} name The name of the instance.
...
function $RouteProvider(){
  ...
  this.$get = ['$rootScope', '$location', '$routeParams', '$q', '$injector', '$http', '$templateCache',
     ...
     * @description
     * Broadcasted before a route change. At this  point the route services.js starts
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
     ...
     * @param {Object.<string, *>=} instanceCache Provides pre-instantiated services.js which should
     *     append/override services.js provided by `providers`. This is handy when unit-testing and having
 ...
 * services.js for data-binding, validation, CSS update, value formatting and parsing. It
